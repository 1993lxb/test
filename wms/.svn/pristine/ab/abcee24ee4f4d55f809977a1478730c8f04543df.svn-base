var _public_priject_msg_list_date_id = "moveTypeListDate";
var _public_priject_msg_save_date_from_id = "_save_moveType_form";
var _public_priject_msg_create_btn_id = "create_moveType_btn_id";
